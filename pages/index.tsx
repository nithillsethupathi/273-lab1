...
const Home: NextPage = () => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center">
      ...
      <div className="mt-[140px] w-full flex-auto">
      ...
      <div className="mt-[-255px] w-full flex-auto">
      </div>
      <div className="w-full flex-auto bg-[#FDEBD2]">
        <div className="flex mt-[18px] w-full items-center flex-auto flex-col px-20">
          <h3 className="text-5xl italic font-semibold">
            What is Etsy?
          </h3>
          <div className="mx-[310px] grid text-center grid-cols-3 gap-12 mt-5">
            <div>
