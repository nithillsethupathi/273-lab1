  ...
  const { data: session } = useSession()
    return(
      <div className="flex min-h-full flex-col items-center">
        <nav className="mx-[30%] flex justify-center p-4">
          <div className="w-[150%] flex flex-shrink-0">
            ...
            {session && (
              <button onClick={() => signOut()} type="submit" className="w-[20%] mt-3 ml-4 flex rounded-full border-white hover:bg-gray-200">Sign Out</button>
            )}
