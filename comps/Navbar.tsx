export default function Navbar(){
    return(
        ...
        <div className="flex flex-shrink-0">
          ...
          <button type="submit" className="ml-2 min-w-[100px] flex justify-center items-center rounded-full border-white hover:bg-gray-200">Sign in</button>
          <button type="submit" className="ml-2 w-12 mx-auto flex justify-center items-center rounded-full border-white hover:bg-gray-200">
