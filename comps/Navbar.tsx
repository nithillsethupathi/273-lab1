      ...
      <div className="flex min-h-full flex-col items-center">
        ...
        <nav className="mx-52 flex justify-between p-4">
          <div className="w-screen flex flex-shrink-0">
            ...
            {!session && (
              <button onClick={() => signIn()} type="submit" className="w-[5%] mt-3 ml-4 flex rounded-full border-white hover:bg-gray-200">Sign in</button>
            )}
            {session && (
              <button onClick={() => signOut()} type="submit" className="w-[5%] mt-3 ml-4 flex rounded-full border-white hover:bg-gray-200">Sign Out</button>
            )}
